          ...
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="border-b border-zinc-200">
                ...
                <th className="py-3 px-2 font-black text-zinc-500 uppercase">Alerta</th>
                <th className="py-3 px-2 font-black text-zinc-500 uppercase">Veículo</th>
                <th className="py-3 px-2 font-black text-zinc-500 uppercase">Tipo</th>
                <th className="py-3 px-2 font-black text-zinc-500 uppercase">Detalhes</th>
              </tr>
            </thead>
            <tbody>
              {alerts.length === 0 ? (
                <tr>
                  <td colSpan={5} className="py-8 text-center text-zinc-400 font-medium text-sm">
                ...
                alerts.map((alert, idx) => {
                  ...
                  return (
                    <tr key={alert.id || idx} className="border-b border-zinc-100 print:border-zinc-200">
                      ...
                      <td className="py-3 px-2 text-zinc-700">{isKm ? "Odomêtro" : "Data"}</td>
                      <td className="py-3 px-2 text-zinc-700">{details}</td>
                    </tr>
                  );
                })
              )}
