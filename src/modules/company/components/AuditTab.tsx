...
export default function AuditTab({ appSettings }: AuditTabProps) {
  ...
  return (
    <div className="space-y-6 font-sans antialiased text-gray-800">
      ...
      {activeSubTab === 'closings' ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4.5">
            <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between">
                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Total em Multas</p>
              ...
              <div className="flex items-center gap-1.5 mt-2.5 text-[10px] text-gray-500 font-bold">
            ...
            <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between">
                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Prêmios & Reversões</p>
            ...
            <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between">
                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Movimentações Ativas</p>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-white rounded-2xl border border-gray-200/80 p-5 flex flex-col md:flex-row items-center justify-between gap-4.5 shadow-sm">
            <div className="space-y-1.5 text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-2">
                ...
                <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">Mecanismo de Auditoria Ativo</h3>
              </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200/70 shadow-sm overflow-hidden flex flex-col">
            ...
            <div className="p-4.5 md:p-5 border-b border-gray-100 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div>
                <h4 className="text-xs font-black text-gray-900 uppercase tracking-widest">Logs de Auditoria Estendida</h4>
                <p className="text-[10px] text-gray-400 font-bold mt-1 uppercase">Histórico analítico de transações de score</p>
              </div>
              ...
              <table className="w-full text-left border-collapse hidden md:table whitespace-nowrap">
                <thead className="bg-gray-50/70 border-b border-gray-150/80 sticky top-0">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-[9px] font-black text-gray-400 uppercase tracking-widest">Tipo</th>
                    <th className="px-6 py-4 text-[9px] font-black text-gray-400 uppercase tracking-widest text-center">Pontuação</th>
                    <th className="px-6 py-4 text-[9px] font-black text-gray-400 uppercase tracking-widest">Justificativa</th>
                    <th className="px-6 py-4 text-[9px] font-black text-gray-400 uppercase tracking-widest text-right">Ação Corretiva</th>
                  </tr>
                </thead>
                      ...
                      return (
                        <tr key={log.id} className="hover:bg-gray-50/20 transition-colors">
                          ...
                          <td className="px-6 py-4.5 max-w-[280px]">
                            <p className="text-xs text-gray-500 font-semibold leading-relaxed truncate hover:text-gray-800 cursor-help" title={log.reason}>
                              {log.reason}
                            </p>
                          </td>
                    ...
                    return (
                      ...
                      >
                        ...
                        {isDeduction && !isContested ? (
                          ...
                          <div className="text-center py-2 bg-gray-100 text-gray-400 font-black uppercase tracking-widest text-[9px] rounded-xl flex items-center justify-center gap-1.5 border border-gray-200/50">
                            <Check size={11} className="stroke-[3]" />
      ...
      <AnimatePresence>
        {showRunConfirm && (
          <div className="fixed inset-0 bg-gray-905/60 backdrop-blur-xs z-50 flex items-center justify-center p-4">
            <motion.div 
              ...
              <div className="p-6">
                ...
                <div className="bg-gradient-to-br from-gray-50 to-white p-4.5 rounded-2xl mb-5 border border-gray-200/60 text-left space-y-2">
                  ...
                  <div className="border-t border-gray-100/80 pt-2 mt-1 flex items-start gap-1">
                    ...
                    <p className="text-[10px] text-gray-500 font-semibold italic">"{contestingLog.reason}"</p>
                  </div>
                </div>
