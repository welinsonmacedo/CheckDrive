                ...
                <div className="pt-4 border-t border-slate-200/60 mt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {vehicle.doc_crlv_url && (
                      <a href={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.doc_crlv_url).data.publicUrl} target="_blank" rel="noreferrer" className="px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-[10px] font-bold text-slate-600 hover:text-indigo-600 hover:border-indigo-200 transition-colors">📄 CRLV</a>
                    )}
                    {vehicle.doc_antt_url && (
                      <a href={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.doc_antt_url).data.publicUrl} target="_blank" rel="noreferrer" className="px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-[10px] font-bold text-slate-600 hover:text-indigo-600 hover:border-indigo-200 transition-colors">📄 ANTT</a>
                    )}
                    {vehicle.doc_insurance_url && (
                      <a href={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.doc_insurance_url).data.publicUrl} target="_blank" rel="noreferrer" className="px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-[10px] font-bold text-slate-600 hover:text-indigo-600 hover:border-indigo-200 transition-colors">📄 Apólice Seguro</a>
                    )}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                    {vehicle.photo_front_url && (
                      <div className="space-y-1">
                        ...
                        <a href={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.photo_front_url).data.publicUrl} target="_blank" rel="noreferrer">
                          <img src={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.photo_front_url).data.publicUrl} alt="Frontal" className="w-full h-16 object-cover rounded-lg border border-slate-200 hover:opacity-80 transition-opacity" />
                        </a>
                      </div>
                    )}
                    {vehicle.photo_right_url && (
                      <div className="space-y-1">
                        ...
                        <a href={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.photo_right_url).data.publicUrl} target="_blank" rel="noreferrer">
                          <img src={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.photo_right_url).data.publicUrl} alt="Direita" className="w-full h-16 object-cover rounded-lg border border-slate-200 hover:opacity-80 transition-opacity" />
                        </a>
                      </div>
                    )}
                    {vehicle.photo_left_url && (
                      <div className="space-y-1">
                        ...
                        <a href={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.photo_left_url).data.publicUrl} target="_blank" rel="noreferrer">
                          <img src={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.photo_left_url).data.publicUrl} alt="Esquerda" className="w-full h-16 object-cover rounded-lg border border-slate-200 hover:opacity-80 transition-opacity" />
                        </a>
                      </div>
                    )}
                    {vehicle.photo_rear_url && (
                      <div className="space-y-1">
                        ...
                        <a href={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.photo_rear_url).data.publicUrl} target="_blank" rel="noreferrer">
                          <img src={supabase.storage.from('vehicles-docs').getPublicUrl(vehicle.photo_rear_url).data.publicUrl} alt="Traseira" className="w-full h-16 object-cover rounded-lg border border-slate-200 hover:opacity-80 transition-opacity" />
                        </a>
                      </div>
                    )}
