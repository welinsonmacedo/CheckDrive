...
content = content.replace(
    /notes: editData\.routeSelectId \? editData\.routeSelectId \? `Rota: \$\{routes\.find\(r => r\.id === editData\.routeSelectId\)\?\.origin\}\$\{routes\.find\(r => r\.id === editData\.routeSelectId\)\?\.destination \? ' - ' \+ routes\.find\(r => r\.id === editData\.routeSelectId\)\?\.destination : ''\}\\nInformação manual` : 'Informação manual'/g,
...
content = content.replace(
    /notes: addFormData\.routeSelectId \? addFormData\.routeSelectId \? `Rota: \$\{routes\.find\(r => r\.id === addFormData\.routeSelectId\)\?\.origin\}\$\{routes\.find\(r => r\.id === addFormData\.routeSelectId\)\?\.destination \? ' - ' \+ routes\.find\(r => r\.id === addFormData\.routeSelectId\)\?\.destination : ''\}\\nInformação manual` : 'Informação manual'/g,
