...
let content = fs.readFileSync('src/components/admin/ReportsTab.tsx', 'utf8');
...
fs.writeFileSync('src/components/admin/ReportsTab.tsx', content);
console.log("Updated purchases logic in admin.");
