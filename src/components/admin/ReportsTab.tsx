    ...
    try {
      ...
      (issuesData || []).forEach((i: any) => {
        ...
        try {
          ...
          console.error("Error parsing NFs in admin report", e);
        }
  ...
  return (
    <div className="space-y-6">
      <div className={selectedDefectToPrint ? "print:hidden" : ""}>
        ...
        <div className="flex flex-col xl:flex-row justify-between items-stretch xl:items-center gap-4 bg-white p-4.5 rounded-2xl shadow-sm border border-gray-200/80 print:hidden font-sans">
        ...
        <div className="hidden print:block mb-8 border-b border-gray-200 pb-5 font-sans">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-[9px] font-black uppercase text-gray-400 tracking-widest leading-none mb-1">Painel Administrativo de Consolidado</p>
              <h1 className="text-xl font-black text-gray-800 tracking-tight font-sans">
                {activeReport === "defects"
                  ? "Inspeção de Ocorrências e Defeitos"
                  : "Indicador de Quilometragem Total"}
              </h1>
            </div>
            <div className="text-right">
              ...
              <p className="text-[8px] uppercase tracking-wider font-extrabold text-gray-400 mt-1">SGI - Administração</p>
            </div>
          </div>
        </div>
          ...
          {activeReport === "defects" ? (
            <>
              <button
                ...
                className="flex items-center gap-2 h-9 px-3.5 bg-rose-50 border border-rose-100/60 hover:bg-rose-100 text-rose-600 text-[10px] font-black uppercase tracking-wider rounded-xl transition-all hover:shadow-sm animate-fade-in"
              >
        ...
        {loading ? (
          ...
          >
                        ...
                        <table className="w-full text-left border-collapse">
                          <thead className="bg-gray-50/70 sticky top-0 border-b border-gray-200/80 z-10">
                            <tr>
                              ...
                              <th className="px-5 py-3.5 text-[9px] font-black text-gray-400 uppercase tracking-widest text-right print:hidden font-sans">
                                Ficha
                              </th>
                            </tr>
                          </thead>
                        ...
                        <table className="w-full text-left border-collapse">
                          <thead className="bg-gray-50/70 sticky top-0 border-b border-gray-200/80 z-10 font-sans">
                            <tr>
                              ...
                              <th className="px-5 py-3.5 text-[9px] font-black text-gray-400 uppercase tracking-widest text-right print:hidden font-sans font-sans">
                                Ficha
                              </th>
                            </tr>
                          </thead>
            ...
            {activeReport === "mileage" && (
              <div className="space-y-6 font-sans">
                <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm overflow-hidden min-h-[400px] flex flex-col print:shadow-none print:border-none print:overflow-visible print:min-h-0 print:h-auto font-sans">
                  <div className="p-4 border-b border-gray-200/80 bg-gray-50/50">
                    <h3 className="text-xs font-black text-gray-800 uppercase tracking-widest flex items-center gap-2">
                      <Truck size={15} className="text-indigo-600" />
                      Acúmulo de Quilometragem Total por Placa (Administração)
                    </h3>
                  </div>
                    ...
                    <table className="w-full text-left border-collapse">
                      <thead className="bg-gray-50/75 sticky top-0 border-b border-gray-200/80 z-10 font-sans">
                        <tr>
                          ...
                          <th className="px-5 py-3.5 text-[9px] font-black text-gray-400 uppercase tracking-widest text-right font-sans font-sans">
                            KM Percorrido (Total)
                          </th>
                        </tr>
                      </thead>
                          ...
                          mileageData.map((item: any, idx: number) => (
                            <tr key={idx} className="hover:bg-gray-50/30 transition-colors">
                              ...
                              <td className="px-5 py-4 text-xs font-bold text-gray-500 whitespace-nowrap">
                                {item.submissionsCount} submissões
                              </td>
