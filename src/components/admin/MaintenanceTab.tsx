                        ...
                        <div key={nf.id} className="bg-zinc-50 border border-zinc-200 rounded-2xl p-4 space-y-3 relative">
                          ...
                          <div>
                            ...
                            <div className="flex gap-2 items-start">
                              ...
                              <label className="cursor-pointer bg-zinc-800 hover:bg-zinc-700 text-white px-3 py-1.5 rounded-xl text-xs font-bold transition-colors whitespace-nowrap flex items-center gap-1.5">
                                <Upload size={14} />
                                Importar XML
                                <input
                                  type="file"
