             ...
             <table className="w-full text-left">
              <thead className="bg-app-bg/50">
                <tr>
                  ...
                  <th className="px-5 py-3 text-[10px] font-bold text-text-muted uppercase tracking-widest">KM</th>
                  <th className="px-5 py-3 text-[10px] font-bold text-text-muted uppercase tracking-widest">Detalhes</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-app-border">
                {loading ? (
                   <tr><td colSpan={4} className="px-5 py-10 text-center text-xs text-text-muted italic">Carregando...</td></tr>
                  ...
                  <tr key={sub.id}>
                    ...
                    <td className="px-5 py-4 text-[11px] font-mono font-bold text-text-main">{sub.odometer ? `${sub.odometer.toLocaleString('pt-BR')} km` : '-'}</td>
                  ...
                  <tr><td colSpan={4} className="px-5 py-10 text-center text-xs text-text-muted italic">Nenhum abastecimento encontrado.</td></tr>
                )}
              </tbody>
             </table>
          </div>
